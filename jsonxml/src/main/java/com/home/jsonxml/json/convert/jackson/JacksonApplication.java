package com.home.jsonxml.json.convert.jackson;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.home.jsonxml.json.model.Product;
...
public class JacksonApplication {
    public static void main(String[] args) throws IOException {
        ...
        // convert from json
        Product newProduct = mapper.readValue(new File("jsonxml/src/main/resources/json/product.json"), Product.class);
